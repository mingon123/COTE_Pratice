...
public class Lv0_130 {
    public int solution(int a, int b) {
        if(a%2==1 && b%2==1) return (int)Math.pow(a, 2) + (int)Math.pow(b, 2); // 제곱
        else if(a%2==0 && b%2==0) return Math.abs(a-b); // 절대값
        else return 2*(a+b);
    }
}

// 문제 요약 : 두 주사위 값 a,b a,b 둘다 홀수 : a^2+b^2
//					  	  a,b 하나 홀수 : 2*(a+b)
//						  a,b 둘다 짝수 : |a-b|
