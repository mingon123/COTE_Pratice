...
public class Lv0_135 {
	public String solution(String myString) {
		for (int i = 0; i < myString.length(); i++) {
			if (myString.charAt(i) < 'l') myString = myString.replace(myString.charAt(i), 'l');
		}
		return myString;
	}
}

// 문제 요약 : 소문자 문자열 mystring, l보다 앞의 문자를 모두 l로 바꾼 문자열 반환

// 한줄코딩 가능 : return myString.replaceAll("[^l-z]", "l");
